...
export default function CompFaq() {
  return (
    <div>
      <div className="2xl:mx-auto 2xl:container py-12 lg:px-20 md:px-6 px-4 mt-[4rem]">
        <div className="w-full flex flex-col justify-center items-center">
          <div className="flex flex-col justify-center items-center text-center space-y-4">
            <h1 className="text-3xl lg:text-4xl font-semibold leading-9 md:leading-7 lg:leading-9">
              Perguntas Frequentes
            </h1>
            <p className="text-base leading-6 text-center text-gray-600 w-full md:w-10/12">
              Aqui estão algumas das perguntas mais frequentes feitas por nossos
              valiosos clientes
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 w-full lg:grid-cols-3 xl:grid-cols-6 justify-items-around gap-x-6 gap-y-6 xl:gap-y-0 xl:gap-x-8 mt-10">
            <button className="w-full focus:outline-none border focus:border-gray-800 border-transparent bg-gray-100 flex justify-center items-center flex-col text-center py-10 px-12 space-y-6">
              <svg
                width={64}
                height={64}
                viewBox="0 0 64 64"
          ...
          <div className="mt-16 flex justify-start flex-col items-start w-full text-left space-y-8">
            <div className=" flex justify-start items-start flex-col text-left w-full xl:w-8/12">
              <h3 className="text-xl font-medium leading-7 md:leading-5 text-left text-gray-800">
                Quanto tempo leva para o meu pacote chegar?
              </h3>
              <p className="mt-6 text-base leading-6 text-gray-600">
                Para itens de prata esterlina, seu pedido será entregue dentro
                de 7 a 10 dias úteis, incluindo produção e entrega, depois que
                você fizer o pedido.
              </p>{" "}
              <br />
            ...
            <div className="flex justify-start items-start flex-col text-left w-full xl:w-8/12 ">
              ...
              <p className="mt-6 text-base leading-6 text-gray-600">
                Lembre-se que pode consultar o estado das suas encomendas a
                qualquer momento em As minhas encomendas na secção A minha
                conta. Se não estiver registado no Mango.com, pode aceder
                directamente na secção Encomendas. Neste caso, você terá que
                inserir seu endereço de e-mail e número do pedido.
              </p>{" "}
              <br />
              <p className="text-base leading-6 text-gray-600">
                Além disso, quando a sua encomenda sair dos nossos armazéns,
                enviar-lhe-emos um e-mail.
              </p>
            </div>
            <hr className="border border-gray-100 w-full" />
            <div className="flex justify-start items-start flex-col text-left w-full xl:w-8/12">
              ...
              <p className="mt-6 text-base leading-6 text-gray-600">
                Sim, você pode alterar ou cancelar seu pedido nos primeiros 10
                dias após a realização do pedido.
              </p>
            </div>
            <hr className="border border-gray-100 w-full" />
          </div>
